...
其中 $ {F1}_{i} $  为第i类的 $ {F1} $ 值，n为类别 $\sqrt{3x-1}+(1+x)^2$ 数，在本 data $\sqrt{3x-1}+(1+x)^2$ data 任务中n取12。

This sentence uses `$` delimiters $\sqrt{3x-1}+(1+x)^2$ to show math inline:  $\sqrt{3x-1}+(1+x)^2$
